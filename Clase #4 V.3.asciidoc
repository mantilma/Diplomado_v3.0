...
- La prima transazione bitcoin è stata fatta da Nakamoto a Hal Finney.
...
6) oltre a essere immutabile o impossibile da commutare o cancellare,
...
- I nodi devono raggiungere un accordo
    ...
    - Se la maggior parte della rete è malevola,
        - il sistema è vulnerabile a errori.
...
- Bitcoin è sicuro?
    ...
    - La crittografia protegge le informazioni in modo sicuro. Vengono utilizzati:
        ...
        - e chiavi private (simile a un PIN segreto di accesso a un conto bancario)
...
4. **Nodi**: Dispositivi connessi a una rete digitale che convalidano, trasmettono, elaborano e archiviano transazioni BTC. (Oltre a essere portafogli, hanno molte altre funzioni)
